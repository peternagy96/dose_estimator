    ...
    def load_data(self):
        ...
        if self.norm == 'Y':
            ...
            for key in train_images.items():
                train_images[key[0]] = self.normalize(train_images[key[0]])#, mod=key[0], per_patient=per_patient, step2=self.step2)
                test_images[key[0]] = self.normalize(test_images[key[0]])#, mod=key[0], per_patient=per_patient, step2=self.step2)
